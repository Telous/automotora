...
class Administrador
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Registro", mappedBy="administrador", orphanRemoval=true)
     */
    private $registros;
    ...
    public function addRegistro(Registro $registro): self
    {
        if (!$this->registros->contains($registro)) {
            ...
            $registro->setAdministrador($this);
        }
    ...
    public function removeRegistro(Registro $registro): self
    {
        if ($this->registros->contains($registro)) {
            ...
            if ($registro->getAdministrador() === $this) {
                $registro->setAdministrador(null);
            }
        }
