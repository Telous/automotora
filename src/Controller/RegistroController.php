...
{
    /**
     * @Route("/", name="registro_all", methods={"GET"})
     */
    ...
    /**
     * @Route("/nuevo", name="registro_new", methods={"GET","POST"})
     */
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('registro_all');
        }
    ...
    /**
     * @Route("/editar/{id}", name="registro_edit", methods={"GET","POST"})
     */
